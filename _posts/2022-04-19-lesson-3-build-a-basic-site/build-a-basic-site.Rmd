...
repository_url: "https://github.com/jarrodscott/stri-mcgill-2022/"
...
Click below if you would like to see the current version of the `_site.yml` file for our course web site. Compare this to the default `_site.yml` file above. You can also access the file [here](https://github.com/jarrodscott/stri-mcgill-2022/blob/main/_site.yml).
...
base_url: https://jarrodscott.github.io/stri-mcgill-2022/
...
navbar:
  ...
  right:
    ...
    - icon: fa-github fa-lg
      href: https://github.com/jarrodscott/stri-mcgill-2022/
    - icon: fa fa-rss
      href: sitemap.xml
output:
  distill::distill_article:
    ...
    toc_depth: 2
    toc_float: true
compare_updates_url: https://github.com/jarrodscott/stri-mcgill-2022/compare/pubv1...master
rss:
  full_content: TRUE
```
